...
\lstset{
    basicstyle=\footnotesize\ttfamily, % f font and size
...
\usepackage[scaled=0.90]{inconsolata} % Monospace font for code/listings
...
\mdfdefinestyle{file}{
	...
	singleextra ={
		...
		at(P-|O){\ttfamily\small\mdfilename};
	},
	firstextra={
		\draw[fill=black!10!white](P)++(0,-1.2em)rectangle(P-|O);
		\node[anchor=north west]
